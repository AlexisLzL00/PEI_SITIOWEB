...
<div class="menu-links" id="menu-links">
    ...
    <div class="menu-with-submenu">
        ...
        <ul class="submenu">
            ...
            <li><a href="clientes.php"><i class="fas fa-file-alt"></i> Mis Clientes</a></li>
        </ul>
    </div>
    ...
    <div class="menu-responsive" id="mobile-menu">
        <div class="menu-responsive-content">
            ...
            <a href="clientes.php"><i class="fas fa-chart-bar"></i> Clientes</a>
            <a href="../logout.php"><i class="fas fa-sign-out-alt"></i> Cerrar Sesión</a>
        </div>
    </div>
    ...
    <div class="container rounded" id="content">
        <div class="row mt-3">
            ...
            <div class="hop cardparaeltexto">
                ...
                <h2 class="color-black">Este seria la Seccion de Itinerario donde se tendran Registros</h2>
