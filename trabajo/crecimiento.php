...
<body>
 ...
 <!--   <header>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            ...
            <li class="nav-item dropdown">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#"><i class="fas fa-tools"></i> Ayuda</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../sesion/login.php"><i class="fas fa-address-card"></i> login / Register</a>
                </li>
    ...
    <section id="bienvenida">
        ...
        <h1>Bienvenido, A Crecimiento (Mantenimiento)</h1>
    </section>
